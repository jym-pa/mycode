...
def main():
    ...
    ######## EXPLORE READ ##########
    ## create file object in "r"ead mode print("Type name of file to examine:")
    print("Enter name of file to be parsed")
    print("For example: vlanconfig.cfg")

    with open(input(), 'r') as configfile:
